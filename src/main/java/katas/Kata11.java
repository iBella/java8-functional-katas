...
public class Kata11 {
	public static List<Map> execute() {
		...
		return lists.stream().map(list -> ImmutableMap.of("name", list.get("name"), "videos", DataKataUtil.videosListIdTitleTimeBoxart(list.get("id"), videos, boxArts, bookmarkList))).collect(Collectors.toList());
	}
}
